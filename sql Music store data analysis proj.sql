...
select billing_country as Country , count(*) as Invoices_count 
from invoice
group by billing_country order by Invoices_count desc;
...
select a.artist_id , a.name , count(a.artist_id) as Total_num_songs
from artist a 
join album 
